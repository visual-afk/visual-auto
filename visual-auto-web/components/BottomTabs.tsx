...
import { PenLine, TrendingUp, Users, LayoutGrid, MessageSquare, MapPin, PieChart, Film, FileCog, type LucideIcon } from 'lucide-react';
...
function tabsFor(role: Role): Tab[] {
  if (role === 'hq_admin') {
    return [
      ...
      { href: '/prompts', label: '프롬프트', icon: FileCog },
